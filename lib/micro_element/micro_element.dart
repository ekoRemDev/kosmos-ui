...
class NutsActivityIndicatorState extends State<LoaderClassique> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    themeData = loadThemeData(widget.theme, "classic_loader", () => const ClassicLoaderThemeData())!;
    _animationController = AnimationController(
      duration: widget.animationDuration ?? themeData.duration ?? const Duration(milliseconds: 800),
      vsync: this,
    );
    if (widget.animating!) {
...
class ProgressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      crossAxisAlignment: customSmallTitle != null ? CrossAxisAlignment.start : CrossAxisAlignment.center,
      children: [
        Text(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: backColor ?? themeData.backColor ?? const Color(0xFFE2E4E7),
...
class ThreeBounceState extends State<ThreeBounce> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller = (widget.controller ?? AnimationController(vsync: this, duration: widget.duration ?? themeData.duration ?? const Duration(milliseconds: 1400)))..repeat();
  }
